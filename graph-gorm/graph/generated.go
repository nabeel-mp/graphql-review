...
func (ec *executionContext) field_Mutation_createUser_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewUser2graphᚑgormᚋgraphᚋmodelᚐNewUser)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Query_users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOUser2ᚕᚖgraphᚑgormᚋgraphᚋmodelᚐUserᚄ,
		true,
		false,
	)
}
...
func (ec *executionContext) unmarshalNNewUser2graphᚑgormᚋgraphᚋmodelᚐNewUser(ctx context.Context, v any) (model.NewUser, error) {
...
func (ec *executionContext) marshalNUser2graphᚑgormᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
...
func (ec *executionContext) marshalOUser2ᚕᚖgraphᚑgormᚋgraphᚋmodelᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNUser2ᚖgraphᚑgormᚋgraphᚋmodelᚐUser(ctx, sel, v[i])
	})
